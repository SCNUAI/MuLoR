...
def create_examples(lines):
    ...
    return examples
def main():
    file = os.path.join('orign_data/', 'test_qtype' + ".json")
    lines = d_read_json(file)
    ...
    for example in tqdm(examples):
        ...
        if sum>=2:
            ...
            ls.append(dic)
    with open(r"train_new"+"2"+".json", 'w', encoding='utf-8') as file:
        file.write(json.dumps(ls, indent=2, ensure_ascii=False))
